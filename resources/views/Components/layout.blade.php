...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scañe=1.0, maximun-scale=1.0, minimun-scale=1.0">
...
<body class="h-full">
          ...
          -->
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="flex shrink-0 items-center">
                        <img class="h-8 w-auto" src="https://laracasts.com/images/logo/logo-triangle.svg?color=indigo&shade=500" alt="Your Company">
                    </div>
    ...
    <main>
        <div class="mx-auto max-w7xl py-6 sm:px-6 lg:px-8">
        {{ $slot }}
        </div>
    </main>
</body>
